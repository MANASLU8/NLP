...
from freq_dictionary import read_freq_dict, construct_entry_info, write_tokens_freq_dictionary
...
def main():
    ...
    vectorizer.get_w2v_embeddings(model_path, "../assets/raw-dataset/train.csv", "../assets/train-embeddings.tsv")
